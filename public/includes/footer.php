    <footer class="site-footer" id="contact">
        ...
        <div class="footer-actions">
            ...
            <div class="footer-logos" aria-label="Logos partenaires">
                <img class="footer-logo footer-logo-iut" src="assets/images/logo-iut.png" alt="IUT de Chambéry">
                <img class="footer-logo footer-logo-mmi" src="assets/images/logo-mmi.png" alt="MMI Chambéry">
            </div>
        </div>
    </footer>
</body>
